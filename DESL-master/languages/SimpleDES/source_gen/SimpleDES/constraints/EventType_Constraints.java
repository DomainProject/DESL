...
public class EventType_Constraints extends BaseConstraintsDescriptor {
  ...
  public static class Name_Property extends BasePropertyConstraintsDescriptor {
    ...
    private static void staticSetPropertyValue(final SNode node, String propertyValue) {
      ...
      SPropertyOperations.assign(ListSequence.fromList(SNodeOperations.getNodeDescendants(SNodeOperations.getNodeAncestor(node, CONCEPTS.DESModel$DK, false, false), CONCEPTS.EventHandler$Ov, false, new SAbstractConcept[]{})).findFirst((it) -> SLinkOperations.getTarget(it, LINKS.event$5cyK) == node), PROPS.eventName$AHdn, propertyValue);
    }
  }
  @Override
