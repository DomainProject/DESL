...
/*package*/ class EventDocs_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public EventDocs_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_vgwwwr_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_vgwwwr_a0");
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_vgwwwr_b0");
    Style style = new StyleImpl();
    new DocsElementStyleClass(this).apply(style, editorCell);
    style.set(StyleAttributes.INDENT_LAYOUT_ON_NEW_LINE, true);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.event$PJOt;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.event$PJOt);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.event$PJOt);
    }
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_vgwwwr_d0");
    Style style = new StyleImpl();
    new DocsElementStyleClass(this).apply(style, editorCell);
  ...
  private EditorCell createConstant_3() {
    ...
    editorCell.setCellId("Constant_vgwwwr_e0");
    Style style = new StyleImpl();
    new DocsElementStyleClass(this).apply(style, editorCell);
    style.set(StyleAttributes.INDENT_LAYOUT_ON_NEW_LINE, true);
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new descriptionSingleRoleHandler_vgwwwr_f0(myNode, LINKS.description$lsoR, getEditorContext());
    return provider.createCell();
  }
  private static class descriptionSingleRoleHandler_vgwwwr_f0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public descriptionSingleRoleHandler_vgwwwr_f0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createConstant_4() {
    ...
    editorCell.setCellId("Constant_vgwwwr_g0");
    Style style = new StyleImpl();
    new DocsElementStyleClass(this).apply(style, editorCell);
    style.set(StyleAttributes.INDENT_LAYOUT_ON_NEW_LINE, true);
    editorCell.getStyle().putAll(style);
