...
public class RootSimGPUM2M_TextGen extends TextGenDescriptorBase {
  @Override
  public void generateText(final TextGenContext ctx) {
    ...
    tgs.append("#include \"random.h\"");
    tgs.newLine();
    tgs.append("#include \"model.h\"");
    tgs.newLine();
    tgs.append("#include \"cuda_gpu.h\"");
    tgs.newLine();
    ...
    tgs.append("__device__ static Nodes nodes;");
    tgs.newLine();
    ...
    for (SNode c : Sequence.fromIterable(SNodeOperations.ofConcept(SLinkOperations.getChildren(ctx.getPrimaryInput(), LINKS.classes$SNAM), CONCEPTS.ClassDefinition$NR))) {
      tgs.append("__device__");
      tgs.newLine();
      tgs.append("void ProcessEventGPU");
      ...
      for (SNode handler : Sequence.fromIterable(SNodeOperations.ofConcept(SLinkOperations.getChildren(c, LINKS.handlers$Nr2P), CONCEPTS.EventHandler$Ov))) {
        ...
        tgs.newLine();
        ctx.getBuffer().area().increaseIndent();
        for (SNode statement : ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(SLinkOperations.getTarget(handler, LINKS.forwardFunction$5bPH), LINKS.body$1GE0), LINKS.statements$euTV))) {
          tgs.indent();
      ...
      if (Sequence.fromIterable(SNodeOperations.ofConcept(SLinkOperations.getChildren(ctx.getPrimaryInput(), LINKS.events$uflG), CONCEPTS.EventDefinition$wO)).where((it) -> SPropertyOperations.getString(SLinkOperations.getTarget(it, LINKS.eventType$MGmZ), PROPS.name$MnvL).equals("LP_FINI")).isEmpty()) {
        tgs.newLine();
        tgs.indent();
    ...
    tgs.append("__device__");
    tgs.newLine();
    tgs.append("void ProcessEventGPU(lp_id_t me, simtime_t now, unsigned event_type, const void *content, unsigned size, void *data)");
    tgs.newLine();
    tgs.append("{");
    tgs.newLine();
    ctx.getBuffer().area().increaseIndent();
