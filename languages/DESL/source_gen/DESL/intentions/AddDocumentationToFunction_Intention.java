...
public final class AddDocumentationToFunction_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  ...
  public AddDocumentationToFunction_Intention() {
    super(Kind.NORMAL, false, new SNodePointer("r:82324c7e-502f-4c1e-82ff-000ec785c25b(DESL.intentions)", "7312148809882581076"));
  }
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      for (SNode parameter : ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.arguments$6da0))) {
        SNode parameterDoc = SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0xc4765525912b41b9L, 0xace4ce3b88117666L, 0x6579f899e5d7c060L, "DESL.structure.ParameterDocs"));
