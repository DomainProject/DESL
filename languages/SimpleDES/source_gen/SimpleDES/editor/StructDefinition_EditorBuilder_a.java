...
/*package*/ class StructDefinition_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new structSingleRoleHandler_aeq9mq_a0(myNode, LINKS.struct$10Oz, getEditorContext());
    return provider.createCell();
  }
  private static class structSingleRoleHandler_aeq9mq_a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public structSingleRoleHandler_aeq9mq_a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
