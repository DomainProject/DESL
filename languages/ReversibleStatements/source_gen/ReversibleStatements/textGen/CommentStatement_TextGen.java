...
public class CommentStatement_TextGen extends TextGenDescriptorBase {
  ...
  public void generateText(final TextGenContext ctx) {
    ...
    if (!((boolean) ITextBlockOwner__BehaviorDescriptor.isEmpty_id7uLL3Mf3Bol.invoke(ctx.getPrimaryInput()))) {
      tgs.append("/* ");
      tgs.newLine();
      Iterable<String> textLines = Text__BehaviorDescriptor.getTextLines_id7T88Na6$wwy.invoke(SLinkOperations.getTarget(SLinkOperations.getTarget(ctx.getPrimaryInput(), LINKS.textblock$1jpS), LINKS.text$ls7a));
