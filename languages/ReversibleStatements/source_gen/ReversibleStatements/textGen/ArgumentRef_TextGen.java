...
public class ArgumentRef_TextGen extends TextGenDescriptorBase {
  ...
  public void generateText(final TextGenContext ctx) {
    ...
    tgs.append(IIdentifierNamedConcept__BehaviorDescriptor.processedName_id3x8oZgL6CjW.invoke(SLinkOperations.getTarget(ctx.getPrimaryInput(), LINKS.arg$bO7D), SPropertyOperations.getString(SLinkOperations.getTarget(ctx.getPrimaryInput(), LINKS.arg$bO7D), PROPS.name$MnvL)));
