...
public class IfStatement_TextGen extends TextGenDescriptorBase {
  ...
  public void generateText(final TextGenContext ctx) {
    ...
    if (SPropertyOperations.getBoolean(ctx.getPrimaryInput(), PROPS.isForward$pAg5) || !(requiresReversibility)) {
      ...
      for (SNode stmt : ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(ctx.getPrimaryInput(), LINKS.thenPart$JklD), LINKS.statements$IdM8))) {
        tgs.indent();
        tgs.appendNode(stmt);
        tgs.newLine();
      }
