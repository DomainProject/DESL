...
public final class CommentStatement__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf75f9e3fb00b4997L, 0x8af20a8ce6b25221L, 0x174e9d736105b2d8L, "ReversibleStatements.structure.CommentStatement");
  ...
  /*package*/ static boolean isEmpty_id7uLL3Mf3Bol(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, LINKS.textblock$1jpS) == null;
  }
  /*package*/ static boolean containsText_idjpyKDg1onB(@NotNull SNode __thisNode__, String text) {
    return (boolean) TextBlock__BehaviorDescriptor.containsText_idjpyKDg1A7A.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.textblock$1jpS), text);
  }
  /*package*/ static String resultName_idjpyKDg1pW5(@NotNull SNode __thisNode__) {
    return (String) TextBlock__BehaviorDescriptor.asTextString_id6byLOcR3jNg.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.textblock$1jpS));
  }
  ...
  private static final class LINKS {
    /*package*/ static final SContainmentLink textblock$1jpS = MetaAdapterFactory.getContainmentLink(0xf75f9e3fb00b4997L, 0x8af20a8ce6b25221L, 0x174e9d736105b2d8L, 0x77b1c43c8f0ff1a3L, "textblock");
  }
}
