...
public class ModelListenersDescriptor implements IModelListenersDescriptor {
  private static final Logger LOG = Logger.getLogger(ModelListenersDescriptor.class);
          ...
          if (SNodeOperations.isInstanceOf(loop, CONCEPTS.IReversibleLoop$k1)) {
            {
              ...
              if (SNodeOperations.isInstanceOf(var, CONCEPTS.INeedSupportVariable$qI)) {
                ...
                if (LOG.isInfoLevel()) {
                  LOG.info("Removing additional variable");
                }
                LogContext.with(ModelListenersDescriptor.class, null, null, null).info("Removing additional variable");
