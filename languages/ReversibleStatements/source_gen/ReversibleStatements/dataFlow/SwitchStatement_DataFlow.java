  ...
  public void build(final DataFlowBuilderContext _context) {
    ...
    if ((boolean) Expression__BehaviorDescriptor.isStaticallyEvaluatable_id3ilck8Kr3zN.invoke(SLinkOperations.getTarget(_context.getNode(), LINKS.expression$QVUr))) {
        ...
        if (SNodeOperations.isInstanceOf(switchCase, CONCEPTS.SwitchCase$tY)) {
          ...
          if (i < SLinkOperations.getChildren(_context.getNode(), LINKS.cases$RiEW).size() - 1) {
            if (caseResult.equals(expressionResult)) {
              _context.getBuilder().emitJump(_context.getBuilder().before(switchCase), "r:c205ea72-20c5-48ea-9b1b-6756ae88d68b(ReversibleStatements.dataFlow)/5781444008245313837");
            }
          }

        } else if (SNodeOperations.isInstanceOf(switchCase, CONCEPTS.SwitchDefault$D7)) {
          _context.getBuilder().emitJump(_context.getBuilder().before(switchCase), "r:c205ea72-20c5-48ea-9b1b-6756ae88d68b(ReversibleStatements.dataFlow)/5781444008245313891");
        } else {
          _context.getBuilder().emitIfJump(_context.getBuilder().before(switchCase), "r:c205ea72-20c5-48ea-9b1b-6756ae88d68b(ReversibleStatements.dataFlow)/5781444008245313896");
          _context.getBuilder().emitJump(_context.getBuilder().after(_context.getNode()), "r:c205ea72-20c5-48ea-9b1b-6756ae88d68b(ReversibleStatements.dataFlow)/5781444008245313899");
        }
      ...
      for (int i = 0; i < ListSequence.fromList(SLinkOperations.getChildren(_context.getNode(), LINKS.cases$RiEW)).count(); i++) {
        ...
        if (i < SLinkOperations.getChildren(_context.getNode(), LINKS.cases$RiEW).size() - 1) {
          _context.getBuilder().emitIfJump(_context.getBuilder().before(switchCase), "r:c205ea72-20c5-48ea-9b1b-6756ae88d68b(ReversibleStatements.dataFlow)/5781444008245313672");
        } else if (SNodeOperations.isInstanceOf(switchCase, CONCEPTS.SwitchDefault$D7)) {
          _context.getBuilder().emitJump(_context.getBuilder().before(switchCase), "r:c205ea72-20c5-48ea-9b1b-6756ae88d68b(ReversibleStatements.dataFlow)/5781444008245313690");
        } else {
          _context.getBuilder().emitIfJump(_context.getBuilder().before(switchCase), "r:c205ea72-20c5-48ea-9b1b-6756ae88d68b(ReversibleStatements.dataFlow)/5781444008245313695");
          _context.getBuilder().emitJump(_context.getBuilder().after(_context.getNode()), "r:c205ea72-20c5-48ea-9b1b-6756ae88d68b(ReversibleStatements.dataFlow)/5781444008245313698");
        }
      }
      for (SNode switchCase : SLinkOperations.getChildren(_context.getNode(), LINKS.cases$RiEW)) {
        _context.getBuilder().build((SNode) switchCase);
