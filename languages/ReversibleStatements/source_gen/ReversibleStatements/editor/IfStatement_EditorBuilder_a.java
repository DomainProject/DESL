...
/*package*/ class IfStatement_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_eb7h0d_a6a0() {
    return Sequence.fromIterable(AttributeOperations.getChildNodesAndAttributes(myNode, LINKS.elseIfs$3PWK)).isNotEmpty();
  }
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new conditionSingleRoleHandler_eb7h0d_c0a(myNode, LINKS.condition$Jk6C, getEditorContext());
  ...
  private static class conditionSingleRoleHandler_eb7h0d_c0a extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.condition$Jk6C, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.condition$Jk6C, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.condition$Jk6C);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.condition$Jk6C));
      try {
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new thenPartSingleRoleHandler_eb7h0d_e0a(myNode, LINKS.thenPart$JklD, getEditorContext());
    return provider.createCell();
  }
  private static class thenPartSingleRoleHandler_eb7h0d_e0a extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      EditorCell editorCell = getUpdateSession().updateChildNodeCell(child);
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.thenPart$JklD, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.thenPart$JklD, child));
      installCellInfo(child, editorCell, false);
      return editorCell;
    }
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.thenPart$JklD);
      }
      Style style = new StyleImpl();
    ...
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.thenPart$JklD));
      try {
        EditorCell editorCell = super.createEmptyCell();
  ...
  private class GenericMenuPart_a0f0a implements MenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    public List<TransformationMenuItem> createItems(final TransformationMenuContext ctx) {
      ...
      final boolean isApplicable = ListSequence.fromList(SLinkOperations.getChildren(SNodeOperations.cast(ctx.getNode(), CONCEPTS.IfStatement$AR), LINKS.elseIfs$3PWK)).isEmpty();
      ...
      if (isApplicable && Sequence.fromIterable(matchingTexts).isNotEmpty()) {
        ListSequence.fromList(items).addElement(new MultiTextActionItem(matchingTexts, ctx) {
          ...
          public SNode doSubstitute(@NotNull String pattern) {
            SNode result = ListSequence.fromList(SLinkOperations.getChildren(SNodeOperations.cast(ctx.getNode(), CONCEPTS.IfStatement$AR), LINKS.elseIfs$3PWK)).insertElement(0, SNodeFactoryOperations.createNewNode(CONCEPTS.ElseIfPart$2p, null));
            EditorContext editorContext = ctx.getEditorContext();
          ...
          public SAbstractConcept getOutputConcept() {
            return CONCEPTS.IfStatement$AR;
          }
    ...
    EditorCell editorCell = ((_FunctionTypes._return_P0_E0<EditorCell>) () -> {
      ...
      if (collection != null) {
        ...
        for (EditorCell child : Sequence.fromIterable(GrammarCellsUtil.getUnwrappedChildren(collection))) {
          if (Objects.equals(child.getSNode().getContainmentLink(), LINKS.elseIfs$3PWK)) {
            ...
            SNodeReference trace = new SNodePointer("r:ad0a2569-6d3a-499c-b8a8-ddd62346572e(ReversibleStatements.editor)", "8945098465480382383");
  ...
  private static class elseIfsListHandler_eb7h0d_a6a0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(elseIfsListHandler_eb7h0d_a6a0.this.getNode(), LINKS.elseIfs$3PWK));
      try {
  ...
  private boolean nodeCondition_eb7h0d_a7a0() {
    return Sequence.fromIterable(AttributeOperations.getChildNodesAndAttributes(myNode, LINKS.elsePart$Do88)).isNotEmpty();
  }
    ...
    EditorCell editorCell = ((_FunctionTypes._return_P0_E0<EditorCell>) () -> {
      cell.setAction(CellActionType.BACKSPACE, new CellActionWithReadAccess() {
        public void execute(EditorContext editorContext) {
          ...
          caretPosition.save();
          SNodeOperations.deleteNode(SLinkOperations.getTarget(node, LINKS.elsePart$Do88));
  ...
  private EditorCell createCustomFactory_4(final EditorContext editorContext, final SNode node) {
    ...
    EditorCell editorCell = ((_FunctionTypes._return_P0_E0<EditorCell>) () -> {
      final SNode childNode = SLinkOperations.getTarget(myNode, LINKS.elsePart$Do88);
      new Object() {
  ...
  private EditorCell createRefNode_2() {
    SingleRoleCellProvider provider = new elsePartSingleRoleHandler_eb7h0d_a0a0h0a(myNode, LINKS.elsePart$Do88, getEditorContext());
    return provider.createCell();
  }
  private static class elsePartSingleRoleHandler_eb7h0d_a0a0h0a extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      EditorCell editorCell = getUpdateSession().updateChildNodeCell(child);
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.elsePart$Do88, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.elsePart$Do88, child));
      installCellInfo(child, editorCell, false);
      return editorCell;
    }
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.elsePart$Do88);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.elsePart$Do88));
      try {
        EditorCell editorCell = super.createEmptyCell();
      ...
      if (Sequence.fromIterable(matchingTexts).isNotEmpty()) {
        ListSequence.fromList(result).addElement(new MultiTextActionItem(matchingTexts, ctx) {
          ...
          public void execute(@NotNull String pattern) {
            final SNode sourceNode = ctx.getNode();
            EditorContext editorContext = ctx.getEditorContext();
            SNode newNode = SNodeFactoryOperations.setNewChild(SNodeOperations.cast(sourceNode, CONCEPTS.IfStatement$AR), LINKS.elsePart$Do88, null);
          }
          @Override
          public SAbstractConcept getOutputConcept() {
            return CONCEPTS.IfStatement$AR;
