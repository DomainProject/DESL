...
/*package*/ class ForVarDecl_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_qvji1e_a2a0() {
    return SNodeOperations.hasRole(myNode, LINKS.iterator$fwes);
  }
      ...
      if (isApplicable) {
        GrammarCellsSideTransformTransformationMenuItem item = new GrammarCellsSideTransformTransformationMenuItem(ctx) {
          ...
          public SNode doSubstitute(String pattern) {
            SNode node = SNodeOperations.cast(ctx.getNode(), CONCEPTS.ForVarDecl$3i);
            IFlagModelAccess access = new DefaultFlagModelAccess(PROPS.static$TPnO);
        ...
        public void execute(EditorContext editorContext) {
          {
            ...
            SNode child = SLinkOperations.getTarget(node, LINKS.init$41s$);
            ...
            if (!(GrammarCellsUtil.isExactly(childConcept, CONCEPTS.ReversibleExpression$Zd))) {
              SNodeFactoryOperations.setNewChild(node, LINKS.init$41s$, null);
              return;
            }
          }
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new initSingleRoleHandler_qvji1e_a5a0(myNode, LINKS.init$41s$, getEditorContext());
    return provider.createCell();
  }
