...
public class deleteLoopSupportVariable {
  private static final Logger LOG = Logger.getLogger(deleteLoopSupportVariable.class);
  ...
  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        if (LOG.isInfoLevel()) {
          LOG.info("Deleting variable with name " + SPropertyOperations.getString(node, PROPS.loopArrayName$wAd5));
        }

        {
          final SNode loop = SNodeOperations.getParent(SNodeOperations.getParent(node));
