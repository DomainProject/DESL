...
/*package*/ class LocalVariableDeclaration_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_i0gfbw_a2a0() {
    return Sequence.fromIterable(AttributeOperations.getChildNodesAndAttributes(myNode, LINKS.prefixes$Lhcv)).isNotEmpty();
  }
  ...
  private boolean nodeCondition_i0gfbw_a0a0() {
    IFlagModelAccess access = new DefaultFlagModelAccess(PROPS.static$TPnO);
      ...
      if (isApplicable) {
        GrammarCellsSideTransformTransformationMenuItem item = new GrammarCellsSideTransformTransformationMenuItem(ctx) {
          ...
          public SNode doSubstitute(String pattern) {
            SNode node = SNodeOperations.cast(ctx.getNode(), CONCEPTS.LocalVariableDeclaration$7E);
            IFlagModelAccess access = new DefaultFlagModelAccess(PROPS.static$TPnO);
          ...
          public SAbstractConcept getOutputConcept() {
            return CONCEPTS.LocalVariableDeclaration$7E;
          }
        };
  ...
  private boolean nodeCondition_i0gfbw_a1a0() {
    IFlagModelAccess access = new DefaultFlagModelAccess(PROPS.extern$rgi8);
    if (!(access.read(myNode))) {
      return false;
    }
  ...
  private static class prefixesListHandler_i0gfbw_a0a2a0 extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.prefixes$Lhcv;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.Prefix$mJ;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(prefixesListHandler_i0gfbw_a0a2a0.this.getNode(), LINKS.prefixes$Lhcv));
      try {
  ...
  private boolean nodeCondition_i0gfbw_a0d0a() {
    IFlagModelAccess access = new DefaultFlagModelAccess(PROPS.storeInRegister$NMWY);
    if (!(access.read(myNode))) {
      return false;
    }
      ...
      return ListSequence.fromList(super.createActions(cellContext, editorContext)).select((action) -> {
        return (SubstituteAction) new NodeSubstituteActionWrapper(action) {
          ...
          public EditorMenuTraceInfo getEditorMenuTraceInfo() {
            ...
            result.setDescriptor(new EditorMenuDescriptorBase("property postfix values", new SNodePointer("r:ad0a2569-6d3a-499c-b8a8-ddd62346572e(ReversibleStatements.editor)", "1850134002004915652")));
            return result;
          }
        };
      }).toList();
  ...
  private boolean nodeCondition_i0gfbw_a2a4a0() {
    return Sequence.fromIterable(AttributeOperations.getChildNodesAndAttributes(myNode, LINKS.init$41s$)).isNotEmpty();
  }
    ...
    EditorCell editorCell = ((_FunctionTypes._return_P0_E0<EditorCell>) () -> {
      cell.setAction(CellActionType.BACKSPACE, new CellActionWithReadAccess() {
        public void execute(EditorContext editorContext) {
          ...
          caretPosition.save();
          SNodeOperations.deleteNode(SLinkOperations.getTarget(node, LINKS.init$41s$));
  ...
  private EditorCell createCustomFactory_16(final EditorContext editorContext, final SNode node) {
    ...
    EditorCell editorCell = ((_FunctionTypes._return_P0_E0<EditorCell>) () -> {
      final SNode childNode = SLinkOperations.getTarget(myNode, LINKS.init$41s$);
      new Object() {
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new initSingleRoleHandler_i0gfbw_b0a0c0e0a(myNode, LINKS.init$41s$, getEditorContext());
    return provider.createCell();
  }
  private static class initSingleRoleHandler_i0gfbw_b0a0c0e0a extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      EditorCell editorCell = getUpdateSession().updateChildNodeCell(child);
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.init$41s$, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.init$41s$, child));
      installCellInfo(child, editorCell, false);
      return editorCell;
    }
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.init$41s$);
      }
      Style style = new StyleImpl();
    ...
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.init$41s$));
      try {
        EditorCell editorCell = super.createEmptyCell();
      ...
      if (Sequence.fromIterable(matchingTexts).isNotEmpty()) {
        ListSequence.fromList(result).addElement(new MultiTextActionItem(matchingTexts, ctx) {
          ...
          public void execute(@NotNull String pattern) {
            final SNode sourceNode = ctx.getNode();
            EditorContext editorContext = ctx.getEditorContext();
            SNode newNode = SNodeFactoryOperations.setNewChild(SNodeOperations.cast(sourceNode, CONCEPTS.LocalVariableDeclaration$7E), LINKS.init$41s$, null);
          }
          @Override
          public SAbstractConcept getOutputConcept() {
            return CONCEPTS.LocalVariableDeclaration$7E;
  ...
  private static final class LINKS {
    /*package*/ static final SContainmentLink prefixes$Lhcv = MetaAdapterFactory.getContainmentLink(0xf75f9e3fb00b4997L, 0x8af20a8ce6b25221L, 0x866dc95fc7a033eL, 0x866dc95fc7a0341L, "prefixes");
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept Prefix$mJ = MetaAdapterFactory.getConcept(0xf75f9e3fb00b4997L, 0x8af20a8ce6b25221L, 0x866dc95fc7a033fL, "ReversibleStatements.structure.Prefix");
