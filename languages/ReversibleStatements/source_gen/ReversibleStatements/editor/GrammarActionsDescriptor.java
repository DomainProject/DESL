...
public class GrammarActionsDescriptor extends AbstractGrammarActionDescriptor implements IGrammarActionsDescriptor {
  ...
  public List<SubstituteMenuItem> getActions(final SubstituteMenuContext _context, final SAbstractConcept expectedOutputConceptExactly) {
    ...
    _context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("ReversibleStatements.editor.GrammarActionsDescriptor.getActions", null));
    try {
      ListSequence.fromList(result).addSequence(Sequence.fromIterable(new Object() {
        public Iterable<SubstituteMenuItem> query() {
          ...
          {
            final SConcept outputConcept = CONCEPTS.LocalVariableDeclaration$7E;
              ...
              for (final SAbstractConcept subconcept : GrammarCellsUtil.getVisibleSubconceptsNonAbstract(outputConcept, _context.getModel(), LocalVariableDeclaration_Editor.class, _context.getEditorContext())) {
                ...
                applicable &= new Object() {
                  public boolean query() {
                    return SConceptOperations.isExactly(SNodeOperations.asSConcept(subconcept), CONCEPTS.LocalVariableDeclaration$7E);
                  }
                }.query();
                if (applicable) {
                  ListSequence.fromList(result).addElement(new FlagSubstituteMenuItem(parentNode, _context.getCurrentTargetNode(), subconcept, "static", _context, new DefaultFlagModelAccess(PROPS.static$TPnO)) {});
                }
              }
            }
          }
...

          {
            ...
            if (SConceptOperations.isExactly(SNodeOperations.asSConcept(outputConcept), SNodeOperations.asSConcept(expectedOutputConceptExactly))) {
              ...
              for (final SAbstractConcept subconcept : GrammarCellsUtil.getVisibleSubconceptsNonAbstract(outputConcept, _context.getModel(), LocalVariableDeclaration_Editor.class, _context.getEditorContext())) {
                ...
                if (applicable) {
                  ListSequence.fromList(result).addElement(new FlagSubstituteMenuItem(parentNode, _context.getCurrentTargetNode(), subconcept, "extern", _context, new DefaultFlagModelAccess(PROPS.extern$rgi8)) {});
                }
              }
            }
          }
      ...
      ListSequence.fromList(result).addSequence(Sequence.fromIterable(new Object() {
        public Iterable<SubstituteMenuItem> query() {
          List<SubstituteMenuItem> result = ListSequence.fromList(new ArrayList<SubstituteMenuItem>());
          _context.getEditorMenuTrace().pushTraceInfo();
          _context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("grammar.wrap in " + "LocalVariableDeclaration", new SNodePointer("r:ad0a2569-6d3a-499c-b8a8-ddd62346572e(ReversibleStatements.editor)", "7617962380317471625")));
          try {
            if (SConceptOperations.isExactly(SNodeOperations.asSConcept(expectedOutputConceptExactly), CONCEPTS.LocalVariableDeclaration$7E)) {
              final SAbstractConcept wrappedConcept = CONCEPTS.Type$dP;
              for (final SConcept subconcept : ListSequence.fromList(GrammarCellsUtil.getVisibleSubconceptsNonAbstract(CONCEPTS.LocalVariableDeclaration$7E, _context.getModel(), LocalVariableDeclaration_Editor.class, _context.getEditorContext()))) {
      ...
      ListSequence.fromList(result).addSequence(Sequence.fromIterable(new Object() {
        public Iterable<SubstituteMenuItem> query() {
          ...
          {
            final SConcept outputConcept = CONCEPTS.ForVarDecl$3i;
...

          {
            ...
            if (SConceptOperations.isExactly(SNodeOperations.asSConcept(outputConcept), SNodeOperations.asSConcept(expectedOutputConceptExactly))) {
              ...
              for (final SAbstractConcept subconcept : GrammarCellsUtil.getVisibleSubconceptsNonAbstract(outputConcept, _context.getModel(), ForVarDecl_Editor.class, _context.getEditorContext())) {
                ...
                boolean applicable = GrammarCellsUtil.canBeChild(subconcept, _context);
                if (applicable) {
                  ListSequence.fromList(result).addElement(new FlagSubstituteMenuItem(parentNode, _context.getCurrentTargetNode(), subconcept, "register", _context, new DefaultFlagModelAccess(PROPS.storeInRegister$NMWY)) {});
                }
              }
            }
          }
      ...
      ListSequence.fromList(result).addSequence(Sequence.fromIterable(new Object() {
        public Iterable<SubstituteMenuItem> query() {
          List<SubstituteMenuItem> result = ListSequence.fromList(new ArrayList<SubstituteMenuItem>());
          _context.getEditorMenuTrace().pushTraceInfo();
          _context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("grammar.wrap in " + "ForVarDecl", new SNodePointer("r:ad0a2569-6d3a-499c-b8a8-ddd62346572e(ReversibleStatements.editor)", "484443907681479415")));
          try {
            if (SConceptOperations.isExactly(SNodeOperations.asSConcept(expectedOutputConceptExactly), CONCEPTS.ForVarDecl$3i)) {
              final SAbstractConcept wrappedConcept = CONCEPTS.Type$dP;
              for (final SConcept subconcept : ListSequence.fromList(GrammarCellsUtil.getVisibleSubconceptsNonAbstract(CONCEPTS.ForVarDecl$3i, _context.getModel(), ForVarDecl_Editor.class, _context.getEditorContext()))) {
                final SConcept outputConcept = ((SConcept) subconcept);
                ...
                if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(outputConcept), SNodeOperations.asSConcept(expectedOutputConcept)) && wrapRequired) {
                  ...
                  isApplicable &= new Object() {
                    public boolean query(SAbstractConcept expectedConcept) {
                      return SConceptOperations.isExactly(SNodeOperations.asSConcept(expectedConcept), CONCEPTS.Iterator$N7);
                    }
      ...
      ListSequence.fromList(result).addSequence(Sequence.fromIterable(new Object() {
        public Iterable<SubstituteMenuItem> query() {
          List<SubstituteMenuItem> result = ListSequence.fromList(new ArrayList<SubstituteMenuItem>());
          _context.getEditorMenuTrace().pushTraceInfo();
          _context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("grammar.wrap in " + "ExpressionStatement", new SNodePointer("r:ad0a2569-6d3a-499c-b8a8-ddd62346572e(ReversibleStatements.editor)", "7617962380317420823")));
          try {
            if (SConceptOperations.isExactly(SNodeOperations.asSConcept(expectedOutputConceptExactly), CONCEPTS.ExpressionStatement$L7)) {
              final SAbstractConcept wrappedConcept = CONCEPTS.ReversibleExpression$Zd;
              for (final SConcept subconcept : ListSequence.fromList(GrammarCellsUtil.getVisibleSubconceptsNonAbstract(CONCEPTS.ExpressionStatement$L7, _context.getModel(), ExpressionStatement_Editor.class, _context.getEditorContext()))) {
                final SConcept outputConcept = ((SConcept) subconcept);
                ...
                if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(outputConcept), SNodeOperations.asSConcept(expectedOutputConcept)) && wrapRequired) {
                  ...
                  final SContainmentLink aggregation = LINKS.expr$YTeC;
                  ...
                  if (isApplicable) {
                    // get all available actions
                    List<SubstituteMenuItem> actions = _context.withLink(LINKS.expr$YTeC).createItems(new DefaultSubstituteMenuLookup(LanguageRegistry.getInstance(_context.getEditorContext().getRepository()), wrappedConcept));
                    // Filter based on grammar.rule conditions
                    List<SubstituteMenuItem> wrappedActions = ListSequence.fromList(actions).where(new _FunctionTypes._return_P1_E0<Boolean, SubstituteMenuItem>() {
                      public Boolean invoke(SubstituteMenuItem it) {
                        // Need to check constraints again for concrete type
                    ...
                    wrappedActions = ListSequence.fromList(wrappedActions).select((final SubstituteMenuItem it) -> {
                      ...
                      SubstituteMenuItem wrapper = new SubstituteMenuItemWrapper(it) {
                        ...
                        public SNode createNode(@NotNull String pattern) {
                          ...
                          // use setupNode after setting wrapped element to allow access to the wrapped element in node factories
                          SNode wrapper = SConceptOperations.createNewNode(SNodeOperations.asInstanceConcept(outputConcept));
                          SLinkOperations.setTarget(wrapper, LINKS.expr$YTeC, SNodeOperations.cast(nodeToWrap, CONCEPTS.ReversibleExpression$Zd));
                          NodeFactoryManager.setupNode(outputConcept, wrapper, _context.getCurrentTargetNode(), _context.getParentNode(), _context.getModel());
  ...
  protected List<TransformationMenuItem> doGetSideTransformActions(final TransformationMenuContext _context) {
    ...
    _context.getEditorMenuTrace().pushTraceInfo();
    _context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("ReversibleStatements.editor.GrammarActionsDescriptor.doGetSideTransformActions", null));
    try {
      {
        final EditorContext editorContext = _context.getEditorContext();
        ...
        ListSequence.fromList(redirectedAfter).addElement(MultiTuple.<TransformationMenuContext,_FunctionTypes._return_P1_E0<? extends Boolean, ? super TransformationMenuContext>>from(new Object() {
          public TransformationMenuContext redirect() {
            ...
            SNode parentNode = new Parser(_context.getModel()).isEndOf(sourceNode, _context.getMenuLocation() == MenuLocations.LEFT_SIDE_TRANSFORM, CONCEPTS.ExpressionStatement$L7, LINKS.expr$YTeC);
            if (parentNode != null) {
              return _context.withNode(parentNode);
            }

            // There might be no grammar for some concepts. Try a single level check.
            if (SNodeOperations.isInstanceOf(sourceNode, CONCEPTS.ReversibleExpression$Zd) && SNodeOperations.isInstanceOf(SNodeOperations.getParent(sourceNode), CONCEPTS.ExpressionStatement$L7) && Objects.equals(sourceNode.getContainmentLink(), LINKS.expr$YTeC) && (_context.getMenuLocation() == MenuLocations.RIGHT_SIDE_TRANSFORM) == false) {
        ...
        new Object() {
          public void withRedirectedContext(final TransformationMenuContext _context) {
            ...
            final SNode sourceNode = _context.getNode();
            EditorContext editorContext = _context.getEditorContext();
            if (SNodeOperations.isInstanceOf(sourceNode, CONCEPTS.ExpressionStatement$L7)) {
              ...
              if (isApplicable && Sequence.fromIterable(matchingTexts).isNotEmpty()) {
                ListSequence.fromList(result).addElement(new MultiTextActionItem(matchingTexts, _context) {
                  ...
                  public SNode doSubstitute(@NotNull String pattern) {
                    SNode sourceNode = SNodeOperations.cast(_context.getNode(), CONCEPTS.ExpressionStatement$L7);
                    SNode returnStatement = SNodeFactoryOperations.replaceWithNewChild(sourceNode, CONCEPTS.ReturnStatement$Kx);
                    SLinkOperations.setTarget(returnStatement, LINKS.expression$ayfU, SLinkOperations.getTarget(sourceNode, LINKS.expr$YTeC));
              ...
              try {
                if (_context.getMenuLocation() == MenuLocations.RIGHT_SIDE_TRANSFORM) {
                  ...
                  if (sourceNode != null) {
                    ...
                    for (final SAbstractConcept subconcept : GrammarCellsUtil.getVisibleSubconceptsNonAbstract(CONCEPTS.ExpressionStatement$L7, _context.getModel(), ExpressionStatement_Editor.class, _context.getEditorContext())) {
                          ...
                          if (sideTransformationEnabled) {
                            ListSequence.fromList(result).addSequence(Sequence.fromIterable(new MultiTextActionItem(matchingText, _context) {
                              ...
                              protected SNode doSubstitute(@Nullable EditorContext editorContext, String pattern) {
                                ...
                                SNode wrapper = SNodeOperations.cast(SNodeFactoryOperations.createNewNode(subconcept, null), CONCEPTS.ExpressionStatement$L7);
                                SNodeOperations.replaceWithAnother(sourceNode, wrapper);
                                SLinkOperations.setTarget(wrapper, LINKS.expr$YTeC, SNodeOperations.cast(sourceNode, CONCEPTS.ReversibleExpression$Zd));
  ...
  public List<IRule> getRules(final SModel contextModel) {
    ...
    {
      final List<SConcept> subconcepts = GrammarCellsUtil.getVisibleSubconceptsNonAbstract(CONCEPTS.ExpressionStatement$L7, visibleLanguages);
      for (final SAbstractConcept subconcept : subconcepts) {
        ListSequence.fromList(rules).addElement(new AbstractRule() {
          ...
          {
            ListSequence.fromList(symbols).addElement(new ChildSymbol(LINKS.expr$YTeC));
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SInterfaceConcept Iterator$N7 = MetaAdapterFactory.getInterfaceConcept(0xf75f9e3fb00b4997L, 0x8af20a8ce6b25221L, 0x347479252a927246L, "ReversibleStatements.structure.Iterator");
