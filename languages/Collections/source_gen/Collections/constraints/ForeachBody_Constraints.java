...
public class ForeachBody_Constraints extends BaseConstraintsDescriptor {
  ...
  public static class VariableName_Property extends BasePropertyConstraintsDescriptor {
    public VariableName_Property(ConstraintsDescriptor container) {
      super(PROPS.variableName$z4I3, container, false, true, false);
    }
    @Override
    ...
    private static void staticSetPropertyValue(SNode node, String propertyValue) {
      SPropertyOperations.assign(node, PROPS.variableName$z4I3, propertyValue);
      if ((SLinkOperations.getTarget(node, LINKS.variable$h_hI) == null)) {
        ...
        SLinkOperations.setTarget(node, LINKS.variable$h_hI, var);
      } else {
        SPropertyOperations.assign(SLinkOperations.getTarget(node, LINKS.variable$h_hI), PROPS.name$MnvL, propertyValue);
      }
    }
  }
  @Override
  protected Map<SProperty, PropertyConstraintsDescriptor> getSpecifiedProperties() {
    ...
    properties.put(PROPS.variableName$z4I3, new VariableName_Property(this));
    return properties;
  }
