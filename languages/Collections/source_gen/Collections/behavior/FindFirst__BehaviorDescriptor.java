...
public final class FindFirst__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x99e1808be2d74c11L, 0xa40f23376c03dda3L, 0x3ea71aa20d4d8882L, "Collections.structure.FindFirst");
  ...
  /*package*/ static Iterable<SNode> getContributedLocalVariables_id3LB9aGm4C$b(@NotNull SNode __thisNode__, SNode node) {
    ...
    ListSequence.fromList(declarations).addElement(SLinkOperations.getTarget(__thisNode__, LINKS.variable$vFqD));
    return declarations;
  }
  ...
  /*package*/ FindFirst__BehaviorDescriptor() {
  }
