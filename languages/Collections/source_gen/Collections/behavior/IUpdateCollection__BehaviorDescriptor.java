...
public final class IUpdateCollection__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getInterfaceConcept(0x99e1808be2d74c11L, 0xa40f23376c03dda3L, 0x1b427f2e49f084f2L, "Collections.structure.IUpdateCollection");
  ...
  /*package*/ static String getBaseName_id2vgMet5LndN(@NotNull SNode __thisNode__) {
    return SNodeOperations.getConcept(__thisNode__).getConceptAlias() + "_";
  }
  /*package*/ static void handleCopyPaste_id33MO5h9wdZT(@NotNull SNode __thisNode__) {
  }

  /*package*/ IUpdateCollection__BehaviorDescriptor() {
  }
