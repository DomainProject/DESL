...
public class BinaryNumberLiteral_TextGen extends TextGenDescriptorBase {
  ...
  public void generateText(final TextGenContext ctx) {
    ...
    String s = Integer.parseInt(SPropertyOperations.getString(ctx.getPrimaryInput(), PROPS.value$jw9Y), 2) + "";
    tgs.append(s);
    tgs.append(" /*0b");
    tgs.append(SPropertyOperations.getString(ctx.getPrimaryInput(), PROPS.value$jw9Y));
    tgs.append("*/");
