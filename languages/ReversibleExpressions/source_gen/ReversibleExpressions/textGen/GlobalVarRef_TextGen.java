...
public class GlobalVarRef_TextGen extends TextGenDescriptorBase {
  ...
  public void generateText(final TextGenContext ctx) {
    ...
    tgs.append(IIdentifierNamedConcept__BehaviorDescriptor.processedName_id3x8oZgL6CjW.invoke(SLinkOperations.getTarget(ctx.getPrimaryInput(), LINKS.var$Q_mg), IModuleContent__BehaviorDescriptor.getMangledName_id19a6$uAAq0e.invoke(SLinkOperations.getTarget(ctx.getPrimaryInput(), LINKS.var$Q_mg))));
