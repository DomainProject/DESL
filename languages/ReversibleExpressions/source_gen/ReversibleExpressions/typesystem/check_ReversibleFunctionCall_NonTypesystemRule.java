...
public class check_ReversibleFunctionCall_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  public check_ReversibleFunctionCall_NonTypesystemRule() {
  }
  public void applyRule(final SNode reversibleFunctionCall, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    List<SNode> actuals = ReversibleFunctionCall__BehaviorDescriptor.getActuals_id2TIMRpJodKn.invoke(reversibleFunctionCall);
    List<SNode> formals = ReversibleFunctionCall__BehaviorDescriptor.getFormals_id2TIMRpJob12.invoke(reversibleFunctionCall);
            ...
            if (SNodeOperations.isInstanceOf(actualType, CONCEPTS.ITypeContainingType$9B) && SNodeOperations.isInstanceOf(SLinkOperations.getTarget(formal_var, LINKS.type$sXU3), CONCEPTS.ITypeContainingType$9B)) {
              ...
              if (SNodeOperations.isInstanceOf(actualBaseType, CONCEPTS.Type$dP) && SNodeOperations.isInstanceOf(formalBaseType, CONCEPTS.Type$dP)) {
                if (SPropertyOperations.getBoolean(SNodeOperations.cast(actualBaseType, CONCEPTS.Type$dP), PROPS.const$VWr7) && !(SPropertyOperations.getBoolean(SNodeOperations.cast(formalBaseType, CONCEPTS.Type$dP), PROPS.const$VWr7))) {
                  {
                    ...
                    IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(actual_var, "cannot pass pointer to const value as argument to parameter expecting pointer to non-const value", "r:a08f1c59-09f4-4839-91dc-89de02b086a5(ReversibleExpressions.typesystem)", "5249288609506979730", null, errorTarget);
                  }
                }
                if (SPropertyOperations.getBoolean(SNodeOperations.cast(actualBaseType, CONCEPTS.Type$dP), PROPS.volatile$hJNe) && !(SPropertyOperations.getBoolean(SNodeOperations.cast(formalBaseType, CONCEPTS.Type$dP), PROPS.volatile$hJNe))) {
                  {
                    final MessageTarget errorTarget = new NodeMessageTarget();
                    IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(actual_var, "cannot pass pointer to volatile value as argument to parameter expecting pointer to non-volatile value", "r:a08f1c59-09f4-4839-91dc-89de02b086a5(ReversibleExpressions.typesystem)", "5249288609506979850", null, errorTarget);
                  }
                }
              }
              ...
              if (SPropertyOperations.getBoolean(actualType, PROPS.const$VWr7) && !(SPropertyOperations.getBoolean(SLinkOperations.getTarget(formal_var, LINKS.type$sXU3), PROPS.const$VWr7))) {
                ...
                if ((SNodeOperations.getNodeAncestor(formal_var, CONCEPTS.ExternalModule$xK, false, false) == null)) {
                  {
                    final MessageTarget errorTarget = new NodeMessageTarget();
                    IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(actual_var, "cannot pass const pointer as argument to parameter expecting non-const pointer", "r:a08f1c59-09f4-4839-91dc-89de02b086a5(ReversibleExpressions.typesystem)", "6683206499712830512", null, errorTarget);
                  }
                }
              }
              if (SPropertyOperations.getBoolean(actualType, PROPS.volatile$hJNe) && !(SPropertyOperations.getBoolean(SLinkOperations.getTarget(formal_var, LINKS.type$sXU3), PROPS.volatile$hJNe))) {
                ...
                if ((SNodeOperations.getNodeAncestor(formal_var, CONCEPTS.ExternalModule$xK, false, false) == null)) {
                  {
                    final MessageTarget errorTarget = new NodeMessageTarget();
                    IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(actual_var, "cannot pass volatile pointer as argument to parameter expecting non-volatile pointer", "r:a08f1c59-09f4-4839-91dc-89de02b086a5(ReversibleExpressions.typesystem)", "6683206499712830527", null, errorTarget);
                  }
                }
              }
              ...
              if (SNodeOperations.isInstanceOf(formalBaseType, CONCEPTS.Type$dP)) {
                if (SPropertyOperations.getBoolean(actualType, PROPS.const$VWr7) && !(SPropertyOperations.getBoolean(SNodeOperations.cast(formalBaseType, CONCEPTS.Type$dP), PROPS.const$VWr7))) {
                  {
                    final MessageTarget errorTarget = new NodeMessageTarget();
                    IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(actual_var, "cannot pass const string as argument to parameter expecting non-const string", "r:a08f1c59-09f4-4839-91dc-89de02b086a5(ReversibleExpressions.typesystem)", "5249288609505875907", null, errorTarget);
                  }
                }
                if (SPropertyOperations.getBoolean(actualType, PROPS.volatile$hJNe) && !(SPropertyOperations.getBoolean(SNodeOperations.cast(formalBaseType, CONCEPTS.Type$dP), PROPS.volatile$hJNe))) {
                  {
                    final MessageTarget errorTarget = new NodeMessageTarget();
                    IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(actual_var, "cannot pass volatile string as argument to parameter expecting non-volatile string", "r:a08f1c59-09f4-4839-91dc-89de02b086a5(ReversibleExpressions.typesystem)", "5249288609505875922", null, errorTarget);
                  }
                }
              }
              ...
              if (SNodeOperations.isInstanceOf(actualBaseType, CONCEPTS.Type$dP)) {
                if (SPropertyOperations.getBoolean(SNodeOperations.cast(actualBaseType, CONCEPTS.Type$dP), PROPS.const$VWr7) && !(SPropertyOperations.getBoolean(SLinkOperations.getTarget(formal_var, LINKS.type$sXU3), PROPS.const$VWr7))) {
                  {
                    final MessageTarget errorTarget = new NodeMessageTarget();
                    IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(actual_var, "cannot pass pointer to const character as argument to parameter expecting non-const string", "r:a08f1c59-09f4-4839-91dc-89de02b086a5(ReversibleExpressions.typesystem)", "5249288609507158181", null, errorTarget);
                  }
                }
                if (SPropertyOperations.getBoolean(SNodeOperations.cast(actualBaseType, CONCEPTS.Type$dP), PROPS.volatile$hJNe) && !(SPropertyOperations.getBoolean(SLinkOperations.getTarget(formal_var, LINKS.type$sXU3), PROPS.volatile$hJNe))) {
                  {
                    final MessageTarget errorTarget = new NodeMessageTarget();
                    IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(actual_var, "cannot pass pointer to volatile character as argument to parameter expecting non-volatile string", "r:a08f1c59-09f4-4839-91dc-89de02b086a5(ReversibleExpressions.typesystem)", "5249288609507158196", null, errorTarget);
                  }
                }
              }
              ...
              if (SPropertyOperations.getBoolean(actualType, PROPS.const$VWr7) && !(SPropertyOperations.getBoolean(SLinkOperations.getTarget(formal_var, LINKS.type$sXU3), PROPS.const$VWr7))) {
                {
                  final MessageTarget errorTarget = new NodeMessageTarget();
                  IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(actual_var, "cannot pass const character pointer or string as argument to parameter expecting non-const string", "r:a08f1c59-09f4-4839-91dc-89de02b086a5(ReversibleExpressions.typesystem)", "5249288609507166532", null, errorTarget);
                }
              }
              if (SPropertyOperations.getBoolean(actualType, PROPS.volatile$hJNe) && !(SPropertyOperations.getBoolean(SLinkOperations.getTarget(formal_var, LINKS.type$sXU3), PROPS.volatile$hJNe))) {
                {
                  final MessageTarget errorTarget = new NodeMessageTarget();
                  IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(actual_var, "cannot pass volatile character pointer or string as argument to parameter expecting non-volatile string", "r:a08f1c59-09f4-4839-91dc-89de02b086a5(ReversibleExpressions.typesystem)", "5249288609507166547", null, errorTarget);
                }
              }
              ...
              if (SPropertyOperations.getBoolean(actualType, PROPS.const$VWr7) && !(SPropertyOperations.getBoolean(SLinkOperations.getTarget(formal_var, LINKS.type$sXU3), PROPS.const$VWr7))) {
                {
                  final MessageTarget errorTarget = new NodeMessageTarget();
                  IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(actual_var, "cannot pass const string as argument to parameter expecting non-const string", "r:a08f1c59-09f4-4839-91dc-89de02b086a5(ReversibleExpressions.typesystem)", "5249288609506873757", null, errorTarget);
                }
              }
              if (SPropertyOperations.getBoolean(actualType, PROPS.volatile$hJNe) && !(SPropertyOperations.getBoolean(SLinkOperations.getTarget(formal_var, LINKS.type$sXU3), PROPS.volatile$hJNe))) {
                {
                  final MessageTarget errorTarget = new NodeMessageTarget();
                  IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(actual_var, "cannot pass volatile string as argument to parameter expecting non-volatile string", "r:a08f1c59-09f4-4839-91dc-89de02b086a5(ReversibleExpressions.typesystem)", "5249288609506873771", null, errorTarget);
                }
              }
              ...
              if (SNodeOperations.isInstanceOf(actualType, CONCEPTS.ITypeContainingType$9B)) {
                if (SPropertyOperations.getBoolean(actualType, PROPS.const$VWr7) && !(SPropertyOperations.getBoolean(SLinkOperations.getTarget(formal_var, LINKS.type$sXU3), PROPS.const$VWr7))) {
                  {
                    final MessageTarget errorTarget = new NodeMessageTarget();
                    IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(actual_var, "cannot pass const argument to non-const parameter", "r:a08f1c59-09f4-4839-91dc-89de02b086a5(ReversibleExpressions.typesystem)", "3625157027073323763", null, errorTarget);
                  }
                }
                if (SPropertyOperations.getBoolean(actualType, PROPS.volatile$hJNe) && !(SPropertyOperations.getBoolean(SLinkOperations.getTarget(formal_var, LINKS.type$sXU3), PROPS.volatile$hJNe))) {
                  {
                    final MessageTarget errorTarget = new NodeMessageTarget();
                    IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(actual_var, "cannot pass volatile argument to non-volatile parameter", "r:a08f1c59-09f4-4839-91dc-89de02b086a5(ReversibleExpressions.typesystem)", "3625157027073440023", null, errorTarget);
                  }
                }
              }
            }
