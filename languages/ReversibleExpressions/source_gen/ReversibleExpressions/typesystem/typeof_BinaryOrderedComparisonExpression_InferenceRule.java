...
public class typeof_BinaryOrderedComparisonExpression_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode boce, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      final SNode lt = typeCheckingContext.typeOf(SLinkOperations.getTarget(boce, LINKS.left$KPKR), "r:a08f1c59-09f4-4839-91dc-89de02b086a5(ReversibleExpressions.typesystem)", "4006257212296688425", true);
      typeCheckingContext.whenConcrete(lt, () -> {
        {
          final SNode rt = typeCheckingContext.typeOf(SLinkOperations.getTarget(boce, LINKS.right$KPZS), "r:a08f1c59-09f4-4839-91dc-89de02b086a5(ReversibleExpressions.typesystem)", "4006257212296688442", true);
          typeCheckingContext.whenConcrete(rt, () -> {
            if (!(SNodeOperations.isInstanceOf(typeCheckingContext.getExpandedNode(lt), CONCEPTS.IOrdered$CJ)) && !(SNodeOperations.isInstanceOf(typeCheckingContext.getExpandedNode(lt), CONCEPTS.MeetType$ZG) && (ListSequence.fromList(SLinkOperations.getChildren(SNodeOperations.cast(typeCheckingContext.getExpandedNode(lt), CONCEPTS.MeetType$ZG), LINKS.argument$r2cT)).findFirst((it) -> SNodeOperations.isInstanceOf(it, CONCEPTS.IOrdered$CJ)) != null))) {
              {
                ...
                IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(boce, "left type not ordered", "r:a08f1c59-09f4-4839-91dc-89de02b086a5(ReversibleExpressions.typesystem)", "1762375172531556559", null, errorTarget);
              }
            }
            if (!(SNodeOperations.isInstanceOf(typeCheckingContext.getExpandedNode(rt), CONCEPTS.IOrdered$CJ)) && !(SNodeOperations.isInstanceOf(typeCheckingContext.getExpandedNode(rt), CONCEPTS.MeetType$ZG) && (ListSequence.fromList(SLinkOperations.getChildren(SNodeOperations.cast(typeCheckingContext.getExpandedNode(rt), CONCEPTS.MeetType$ZG), LINKS.argument$r2cT)).findFirst(new _FunctionTypes._return_P1_E0<Boolean, SNode>() {
              ...
              {
                final MessageTarget errorTarget = new NodeMessageTarget();
                IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(boce, "right type not ordered", "r:a08f1c59-09f4-4839-91dc-89de02b086a5(ReversibleExpressions.typesystem)", "1762375172531556623", null, errorTarget);
              }
            }
            {
              SNode _nodeToCheck_1029348928467 = boce;
              EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:a08f1c59-09f4-4839-91dc-89de02b086a5(ReversibleExpressions.typesystem)", "4006257212296601191", 0, null);
              typeCheckingContext.createComparableEquation((SNode) typeCheckingContext.typeOf(SLinkOperations.getTarget(boce, LINKS.left$KPKR), "r:a08f1c59-09f4-4839-91dc-89de02b086a5(ReversibleExpressions.typesystem)", "4006257212296601193", true), (SNode) typeCheckingContext.typeOf(SLinkOperations.getTarget(boce, LINKS.right$KPZS), "r:a08f1c59-09f4-4839-91dc-89de02b086a5(ReversibleExpressions.typesystem)", "4006257212296601199", true), false, _info_12389875345);
            }
            ...
            {
              SNode _nodeToCheck_1029348928467 = boce;
              EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:a08f1c59-09f4-4839-91dc-89de02b086a5(ReversibleExpressions.typesystem)", "4006257212296554273", 0, null);
              typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:a08f1c59-09f4-4839-91dc-89de02b086a5(ReversibleExpressions.typesystem)", "4006257212296554278", true), (SNode) bt, _info_12389875345);
            }
          }, "r:a08f1c59-09f4-4839-91dc-89de02b086a5(ReversibleExpressions.typesystem)", "4006257212296688439", false, false);
        }
      }, "r:a08f1c59-09f4-4839-91dc-89de02b086a5(ReversibleExpressions.typesystem)", "4006257212296688422", false, false);
    }
  }
  public SAbstractConcept getApplicableConcept() {
    return CONCEPTS.BinaryOrderedComparisonExpression$5v;
  }
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept BinaryOrderedComparisonExpression$5v = MetaAdapterFactory.getConcept(0x9abffa92487542bfL, 0x9379c4f95eb496d4L, 0x187536e1c7b61d87L, "ReversibleExpressions.structure.BinaryOrderedComparisonExpression");
  }
