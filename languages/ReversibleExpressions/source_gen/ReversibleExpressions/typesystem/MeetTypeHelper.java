...
public class MeetTypeHelper {
  ...
  public static SNode getConcreteType(SNode type) {
    if (SNodeOperations.isInstanceOf(type, CONCEPTS.ITypeDecorator$WP)) {
      return SNodeOperations.copyNode(getConcreteType(SLinkOperations.getTarget(SNodeOperations.cast(type, CONCEPTS.ITypeDecorator$WP), LINKS.valueType$USUy)));
    }
  ...
  public static SNode getConcreteNonConstVolatileSignedType(SNode type) {
    if (SNodeOperations.isInstanceOf(type, CONCEPTS.ITypeDecorator$WP)) {
      SNode copy = SNodeOperations.cast(SNodeOperations.copyNode(type), CONCEPTS.ITypeDecorator$WP);
      SLinkOperations.setTarget(copy, LINKS.valueType$USUy, getConcreteNonConstVolatileSignedType(SLinkOperations.getTarget(SNodeOperations.cast(type, CONCEPTS.ITypeDecorator$WP), LINKS.valueType$USUy)));
  ...
  public static SNode getConcreteNonConstVolatileUnsignedType(SNode type) {
    if (SNodeOperations.isInstanceOf(type, CONCEPTS.ITypeDecorator$WP)) {
      SNode copy = SNodeOperations.cast(SNodeOperations.copyNode(type), CONCEPTS.ITypeDecorator$WP);
      SLinkOperations.setTarget(copy, LINKS.valueType$USUy, getConcreteNonConstVolatileUnsignedType(SLinkOperations.getTarget(SNodeOperations.cast(type, CONCEPTS.ITypeDecorator$WP), LINKS.valueType$USUy)));
      return SNodeOperations.cast(copy, CONCEPTS.Type$dP);
    }
    if (SNodeOperations.isInstanceOf(type, CONCEPTS.DerivedPrimitiveType$C0)) {
      type = DerivedPrimitiveType__BehaviorDescriptor.getBaseType_id3dCMHw1DZZS.invoke(SNodeOperations.cast(type, CONCEPTS.DerivedPrimitiveType$C0));
