...
import ReversibleExpressions.actions.ActionAspectDescriptorImpl;
import jetbrains.mps.smodel.runtime.BehaviorAspectDescriptor;
import jetbrains.mps.smodel.runtime.ConstraintsAspectDescriptor;
import jetbrains.mps.openapi.editor.descriptor.EditorAspectDescriptor;
import ReversibleExpressions.editor.EditorAspectDescriptorImpl;
import jetbrains.mps.openapi.intentions.IntentionAspectDescriptor;
import ReversibleExpressions.intentions.IntentionsDescriptor;
import jetbrains.mps.lang.migration.runtime.base.MigrationAspectDescriptor;
import ReversibleExpressions.migration.MigrationDescriptor;
import jetbrains.mps.lang.script.runtime.ScriptAspectDescriptor;
import ReversibleExpressions.scripts.ScriptsDescriptor;
import jetbrains.mps.text.rt.TextGenAspectDescriptor;
import jetbrains.mps.lang.typesystem.runtime.IHelginsDescriptor;
import ReversibleExpressions.typesystem.TypesystemDescriptor;
import jetbrains.mps.smodel.runtime.StructureAspectDescriptor;
import jetbrains.mps.smodel.runtime.ConceptPresentationAspect;
import ReversibleExpressions.structure.ConceptPresentationAspectImpl;
import jetbrains.mps.lang.dataFlow.framework.DataFlowAspectDescriptor;
import ReversibleExpressions.dataFlow.DataFlowAspectDescriptorImpl;
...
public class Language extends LanguageRuntime {
  ...
  public Language() {
    myId = SLanguageId.deserialize("9abffa92-4875-42bf-9379-c4f95eb496d4");
  }

  @Override
  public String getNamespace() {
    return "ReversibleExpressions";
  }
  ...
  protected <T extends ILanguageAspect> T createAspect(Class<T> aspectClass) {
    ...
    if (aspectClass == BehaviorAspectDescriptor.class) {
      return aspectClass.cast(new ReversibleExpressions.behavior.BehaviorAspectDescriptor());
    }
    if (aspectClass == ConstraintsAspectDescriptor.class) {
      return aspectClass.cast(new ReversibleExpressions.constraints.ConstraintsAspectDescriptor());
    }
    ...
    if (aspectClass == TextGenAspectDescriptor.class) {
      return aspectClass.cast(new ReversibleExpressions.textGen.TextGenAspectDescriptor());
    }
    if (aspectClass == IHelginsDescriptor.class) {
      return aspectClass.cast(new TypesystemDescriptor());
    }
    if (aspectClass == StructureAspectDescriptor.class) {
      return aspectClass.cast(new ReversibleExpressions.structure.StructureAspectDescriptor());
    }
