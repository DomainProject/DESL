...
public final class CharLiteral__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x9abffa92487542bfL, 0x9379c4f95eb496d4L, 0x17196bfd1c5318acL, "ReversibleExpressions.structure.CharLiteral");
  ...
  /*package*/ static boolean isStaticallyEvaluatable_id3ilck8Kr3zN(@NotNull SNode __thisNode__) {
    ...
    return SPropertyOperations.getString(__thisNode__, PROPS.value$ePdR) != null;
  }
  /*package*/ static Object evaluateStatically_id6OxpEKG0KPv(@NotNull SNode __thisNode__) {
    if (isNotEmptyString(SPropertyOperations.getString(__thisNode__, PROPS.value$ePdR))) {
      int charAt = ((int) SPropertyOperations.getString(__thisNode__, PROPS.value$ePdR).charAt(0));
  ...
  /*package*/ static String renderReadable_id1VQvajLb13M(@NotNull SNode __thisNode__) {
    return "'" + SPropertyOperations.getString(__thisNode__, PROPS.value$ePdR) + "'";
  }
