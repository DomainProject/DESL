...
public final class BitwiseAndExpression__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x9abffa92487542bfL, 0x9379c4f95eb496d4L, 0x52bff1066a5caaafL, "ReversibleExpressions.structure.BitwiseAndExpression");
  ...
  /*package*/ static Object evaluateStatically_id6OxpEKG0KPv(@NotNull SNode __thisNode__) {
    return NumberEvaluationHelper.bitAnd(NumberEvaluationHelper.asInt(ReversibleExpression__BehaviorDescriptor.evaluateStatically_id6OxpEKG0KPv.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.left$KPKR))), NumberEvaluationHelper.asInt(ReversibleExpression__BehaviorDescriptor.evaluateStatically_id6OxpEKG0KPv.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.right$KPZS))));
  }
  ...
  /*package*/ static String getReversedOperator_id4e6KBjCJeOF(@NotNull SNode __thisNode__) {
    // todo this should never be reversed
    return "&";
  }
