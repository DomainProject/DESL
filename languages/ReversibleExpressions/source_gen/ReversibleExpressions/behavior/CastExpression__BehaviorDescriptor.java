...
public final class CastExpression__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x9abffa92487542bfL, 0x9379c4f95eb496d4L, 0x5bbe8a6d239d0b54L, "ReversibleExpressions.structure.CastExpression");
  ...
  private static void ___init___(@NotNull SNode __thisNode__) {
    SLinkOperations.setTarget(__thisNode__, LINKS.expr$VQmo, SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0x9abffa92487542bfL, 0x9379c4f95eb496d4L, 0x4ffba68fe82dd4c7L, "ReversibleExpressions.structure.ParensExpression")));
  }
  ...
  /*package*/ static String renderReadable_id1VQvajLb13M(@NotNull SNode __thisNode__) {
    return "(" + SNodeOperations.present(SLinkOperations.getTarget(__thisNode__, LINKS.targetType$VX9P)) + ")" + Expression__BehaviorDescriptor.renderReadable_id1VQvajLb13M.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.expr$VQmo));
  }
  /*package*/ static boolean isSideeffectFree_id6SENleF$SRD(@NotNull SNode __thisNode__) {
    return (boolean) Expression__BehaviorDescriptor.isSideeffectFree_id6SENleF$SRD.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.expr$VQmo));
  }
  /*package*/ static boolean isStaticallyEvaluatable_id3ilck8Kr3zN(@NotNull SNode __thisNode__) {

    SNode targetType = SLinkOperations.getTarget(__thisNode__, LINKS.targetType$VX9P);
    ...
    if (!(SNodeOperations.isInstanceOf(targetType, CONCEPTS.PrimitiveC99IntegralType$E_)) || !((boolean) Expression__BehaviorDescriptor.isStaticallyEvaluatable_id3ilck8Kr3zN.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.expr$VQmo)))) {
      return false;
    }

    if (Expression__BehaviorDescriptor.evaluateStatically_id6OxpEKG0KPv.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.expr$VQmo)) instanceof BigInteger) {
      return true;
    }
  ...
  /*package*/ static Object evaluateStatically_id6OxpEKG0KPv(@NotNull SNode __thisNode__) {
    ...
    Object exprValueObj = Expression__BehaviorDescriptor.evaluateStatically_id6OxpEKG0KPv.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.expr$VQmo));
  ...
  /*package*/ static SNode getSyntacticallyRightSideExpression_id6mzZsELnTMK(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, LINKS.expr$VQmo);
  }
  /*package*/ static void setSyntacticallyRightSideExpression_id6mzZsELnSmP(@NotNull SNode __thisNode__, SNode expression) {
    SLinkOperations.setTarget(__thisNode__, LINKS.expr$VQmo, SNodeOperations.cast(expression, CONCEPTS.ReversibleExpression$Zd));
  }
  /*package*/ static String getPresentation_idhEwIMiw(@NotNull SNode __thisNode__) {
    return "(" + ((SLinkOperations.getTarget(__thisNode__, LINKS.targetType$VX9P) != null ? SConceptOperations.conceptAlias(SNodeOperations.getConcept(SLinkOperations.getTarget(__thisNode__, LINKS.targetType$VX9P))) : "null")) + ") " + BaseConcept__BehaviorDescriptor.getPresentation_idhEwIMiw.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.expr$VQmo));
  }
