...
import com.mbeddr.core.modules.behavior.AbstractDefineLike__BehaviorDescriptor;
...
public final class GlobalConstantRef__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x9abffa92487542bfL, 0x9379c4f95eb496d4L, 0x4ea2fd39ef8cd6f8L, "ReversibleExpressions.structure.GlobalConstantRef");
  ...
  /*package*/ static boolean isStaticallyEvaluatable_id3ilck8Kr3zN(@NotNull SNode __thisNode__) {
    ...
    if (__thisNode__ != SLinkOperations.getTarget(SLinkOperations.getTarget(__thisNode__, LINKS.constant$ODeS), LINKS.value$RmDl)) {
      return (boolean) Expression__BehaviorDescriptor.isStaticallyEvaluatable_id3ilck8Kr3zN.invoke(SLinkOperations.getTarget(SLinkOperations.getTarget(__thisNode__, LINKS.constant$ODeS), LINKS.value$RmDl));
    } else {
      return false;
    }
  }
  /*package*/ static Object evaluateStatically_id6OxpEKG0KPv(@NotNull SNode __thisNode__) {
    return (Object) Expression__BehaviorDescriptor.evaluateStatically_id6OxpEKG0KPv.invoke(SLinkOperations.getTarget(SLinkOperations.getTarget(__thisNode__, LINKS.constant$ODeS), LINKS.value$RmDl));
  }
  /*package*/ static void rebindToProxy_id7jSUHHvkApb(@NotNull SNode __thisNode__, SNode proxyElement) {
    SLinkOperations.setTarget(__thisNode__, LINKS.constant$ODeS, SNodeOperations.cast(proxyElement, CONCEPTS.GlobalConstantDeclaration$dg));
  }
  /*package*/ static SNode referencedModuleContent_id7jSUHHvkAph(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, LINKS.constant$ODeS);
  }
  /*package*/ static String renderReadable_id1VQvajLb13M(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.constant$ODeS), PROPS.name$MnvL);
  }
  /*package*/ static boolean isLValue_id6iIoqg1yDKH(@NotNull SNode __thisNode__) {
    return (boolean) AbstractDefineLike__BehaviorDescriptor.resultIsLValue_id4b64BCc0upM.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.constant$ODeS));
  }
