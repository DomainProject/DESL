...
public final class GlobalVarRef__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x9abffa92487542bfL, 0x9379c4f95eb496d4L, 0x4ea2fd39f03d3a05L, "ReversibleExpressions.structure.GlobalVarRef");
  ...
  /*package*/ static void rebindToProxy_id7jSUHHvkApb(@NotNull SNode __thisNode__, SNode proxyElement) {
    SLinkOperations.setTarget(__thisNode__, LINKS.var$Q_mg, SNodeOperations.cast(proxyElement, CONCEPTS.GlobalVariableDeclaration$TW));
  }
  /*package*/ static SNode referencedModuleContent_id7jSUHHvkAph(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, LINKS.var$Q_mg);
  }
