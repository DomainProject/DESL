...
public final class ParensExpression__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x9abffa92487542bfL, 0x9379c4f95eb496d4L, 0x4ffba68fe82dd4c7L, "ReversibleExpressions.structure.ParensExpression");
  ...
  /*package*/ static Object evaluateStatically_id6OxpEKG0KPv(@NotNull SNode __thisNode__) {
    return (Object) ReversibleExpression__BehaviorDescriptor.evaluateStatically_id6OxpEKG0KPv.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.expression$HKAI));
  }
  /*package*/ static String renderReadable_id1VQvajLb13M(@NotNull SNode __thisNode__) {
    return "(" + ReversibleExpression__BehaviorDescriptor.renderReadable_id1VQvajLb13M.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.expression$HKAI)) + ")";
  }
  ...
  /*package*/ static String getPresentation_idhEwIMiw(@NotNull SNode __thisNode__) {
    return "(" + BaseConcept__BehaviorDescriptor.getPresentation_idhEwIMiw.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.expression$HKAI)) + ")";
  }
  /*package*/ static boolean isLValue_id6iIoqg1yDKH(@NotNull SNode __thisNode__) {
    return (boolean) ReversibleExpression__BehaviorDescriptor.isLValue_id6iIoqg1yDKH.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.expression$HKAI));
  }
  /*package*/ static SNode getCodeForTarget_id1uoAWUPe22W(@NotNull SNode __thisNode__) {
    return ReversibleExpression__BehaviorDescriptor.getCodeForTarget_id1uoAWUPe22W.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.expression$HKAI));
  }
  /*package*/ static SNode getWriteTarget_id1uoAWUPe2Ie(@NotNull SNode __thisNode__) {
    return ReversibleExpression__BehaviorDescriptor.getWriteTarget_id1uoAWUPe2Ie.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.expression$HKAI));
  }
