...
public class NumberEvaluationHelper extends EH {
  ...
  public static SNode toNode(Object num) {
    if (EH.isNumber(num)) {
      SNode nl = SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0x9abffa92487542bfL, 0x9379c4f95eb496d4L, 0x7af69e2e83a1ba67L, "ReversibleExpressions.structure.NumberLiteral"));
      SPropertyOperations.assign(nl, PROPS.value$jw9Y, num.toString());
      return nl;
    }
  ...
  public static SNode staticType(SNode leftType, SNode rightType, SNode e) {
    if ((boolean) ReversibleExpression__BehaviorDescriptor.isStaticallyEvaluatable_id3ilck8Kr3zN.invoke(e)) {
      ...
      if (SNodeOperations.isInstanceOf(e, CONCEPTS.BinaryExpression$b) && SNodeOperations.isInstanceOf(type, CONCEPTS.MeetType$ZG) && SNodeOperations.isInstanceOf(leftType, CONCEPTS.IUnsigned$5A) && SNodeOperations.isInstanceOf(rightType, CONCEPTS.IUnsigned$5A)) {
