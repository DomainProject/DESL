...
public final class GenericDotExpression__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x9abffa92487542bfL, 0x9379c4f95eb496d4L, 0x401df715da462c0cL, "ReversibleExpressions.structure.GenericDotExpression");

  public static final SMethod<String> getRepresentation_id66uzewbvZAY = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getRepresentation").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7034214596252531134L).languageId(0x9379c4f95eb496d4L, 0x9abffa92487542bfL).build2();
  ...
  /*package*/ static String getRepresentation_id66uzewbvZAY(@NotNull SNode __thisNode__) {
    if (SNodeOperations.isInstanceOf(SLinkOperations.getTarget(__thisNode__, LINKS.expression$HKAI), CONCEPTS.StringValue$z6)) {
      return "->";
    }

    if ((SLinkOperations.getTarget(__thisNode__, LINKS.target$xbCZ) != null) && (boolean) IGenericDotTarget__BehaviorDescriptor.forceDot_id4Xtub2u6BpJ.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.target$xbCZ))) {
      return ".";
    }
    SNode tsType = TypecheckingFacade.getFromContext().getTypeOf(SLinkOperations.getTarget(__thisNode__, LINKS.expression$HKAI));


    if (SNodeOperations.isInstanceOf(SLinkOperations.getTarget(__thisNode__, LINKS.expression$HKAI), CONCEPTS.IVariableReference$Kb)) {
      tsType = IVariableDeclaration__BehaviorDescriptor.getDeclaredType_id1LDGRqyYkTX.invoke(IVariableReference__BehaviorDescriptor.getVariable_id1LDGRqyQFAf.invoke(SNodeOperations.cast(SLinkOperations.getTarget(__thisNode__, LINKS.expression$HKAI), CONCEPTS.IVariableReference$Kb)));
    } else if (SNodeOperations.isInstanceOf(SLinkOperations.getTarget(__thisNode__, LINKS.expression$HKAI), CONCEPTS.GenericDotExpression$ia)) {
      tsType = SLinkOperations.getTarget(SLinkOperations.getTarget(SNodeOperations.cast(SLinkOperations.getTarget(SNodeOperations.cast(SLinkOperations.getTarget(__thisNode__, LINKS.expression$HKAI), CONCEPTS.GenericDotExpression$ia), LINKS.target$xbCZ), CONCEPTS.GenericMemberRef$Ue), LINKS.member$gCRV), LINKS.type$sXU3);
    }
  ...
  /*package*/ static String renderReadable_id1VQvajLb13M(@NotNull SNode __thisNode__) {
    String renderedTarget = IGenericDotTarget__BehaviorDescriptor.renderReadable_id4Xtub2u6yiL.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.target$xbCZ));
    return Expression__BehaviorDescriptor.renderReadable_id1VQvajLb13M.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.expression$HKAI)) + GenericDotExpression__BehaviorDescriptor.getRepresentation_id66uzewbvZAY.invoke(__thisNode__) + renderedTarget;
  }
  /*package*/ static boolean isLValue_id6iIoqg1yDKH(@NotNull SNode __thisNode__) {
    return (boolean) IGenericDotTarget__BehaviorDescriptor.isLValue_id4Xtub2u6Be$.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.target$xbCZ));
  }
  ...
  private static final class CONCEPTS {
    /*package*/ static final SConcept StringValue$z6 = MetaAdapterFactory.getConcept(0xc4765525912b41b9L, 0xace4ce3b88117666L, 0x38ef3b1b01d56c89L, "DESL.structure.StringValue");
