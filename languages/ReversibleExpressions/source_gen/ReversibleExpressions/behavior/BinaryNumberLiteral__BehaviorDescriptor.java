...
public final class BinaryNumberLiteral__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x9abffa92487542bfL, 0x9379c4f95eb496d4L, 0xea19691e38cf3f6L, "ReversibleExpressions.structure.BinaryNumberLiteral");
  ...
  /*package*/ static Object evaluateStatically_id6OxpEKG0KPv(@NotNull SNode __thisNode__) {
    if (isNotEmptyString(SPropertyOperations.getString(__thisNode__, PROPS.value$jw9Y))) {
      return new BigInteger(SPropertyOperations.getString(__thisNode__, PROPS.value$jw9Y), 2);
    } else {
      return BigInteger.ZERO;
    }
  }
  /*package*/ static String renderReadable_id1VQvajLb13M(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getString(__thisNode__, PROPS.value$jw9Y) + "b";
  }
