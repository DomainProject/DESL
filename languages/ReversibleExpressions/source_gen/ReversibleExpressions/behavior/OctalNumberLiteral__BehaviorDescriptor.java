...
public final class OctalNumberLiteral__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x9abffa92487542bfL, 0x9379c4f95eb496d4L, 0xd04cd1bfc474145L, "ReversibleExpressions.structure.OctalNumberLiteral");
  ...
  /*package*/ static Object evaluateStatically_id6OxpEKG0KPv(@NotNull SNode __thisNode__) {
    if (isNotEmptyString(SPropertyOperations.getString(__thisNode__, PROPS.value$jw9Y))) {
      return new BigInteger(SPropertyOperations.getString(__thisNode__, PROPS.value$jw9Y), 8);
    } else {
      return BigInteger.ZERO;
    }
  }
  /*package*/ static String renderReadable_id1VQvajLb13M(@NotNull SNode __thisNode__) {
    return "0" + SPropertyOperations.getString(__thisNode__, PROPS.value$jw9Y);
  }
