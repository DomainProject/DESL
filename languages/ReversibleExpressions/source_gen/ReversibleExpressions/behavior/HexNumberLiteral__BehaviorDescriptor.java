...
public final class HexNumberLiteral__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x9abffa92487542bfL, 0x9379c4f95eb496d4L, 0xea19691e38c3fccL, "ReversibleExpressions.structure.HexNumberLiteral");
  ...
  /*package*/ static Object evaluateStatically_id6OxpEKG0KPv(@NotNull SNode __thisNode__) {
    String value = SPropertyOperations.getString(__thisNode__, PROPS.value$jw9Y);
  ...
  /*package*/ static String renderReadable_id1VQvajLb13M(@NotNull SNode __thisNode__) {
    return "0x" + SPropertyOperations.getString(__thisNode__, PROPS.value$jw9Y);
  }
