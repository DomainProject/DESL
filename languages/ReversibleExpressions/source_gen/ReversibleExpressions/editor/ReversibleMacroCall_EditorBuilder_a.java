...
/*package*/ class ReversibleMacroCall_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ReversibleMacroCall_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_18rw23_a");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.macro$QKaR;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.macro$QKaR);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.macro$QKaR);
    }
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new ReferenceCellContext(getNode(), getNode(), referenceLink), new SubstituteInfoPartExt[]{new ReversibleMacroCall_macro_cellMenu_18rw23_a0a0(), new SChildSubstituteInfoPartEx(editorCell)}));
  ...
  public static class ReversibleMacroCall_macro_cellMenu_18rw23_a0a0 extends PrimaryReferentMenuCellMenuPart {
    public ReversibleMacroCall_macro_cellMenu_18rw23_a0a0() {
    }
    @NotNull
    @Override
    protected IReferentPresentationProvider getMatchingTextProvider() {
      return PresentationProviders.PRESENTATION_18rw23_a0a0a;
    }
    @NotNull
    @Override
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_18rw23_b0");
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new actualsListHandler_18rw23_c0(myNode, getEditorContext());
  ...
  private static class actualsListHandler_18rw23_c0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public actualsListHandler_18rw23_c0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SContainmentLink getSLink() {
      return LINKS.actuals$QKpS;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.ReversibleMacroArg$Ip;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(actualsListHandler_18rw23_c0.this.getNode(), LINKS.actuals$QKpS));
      try {
    ...
    private EditorCell createReadOnlyModelAccessor_0() {
      ...
      editorCell.setCellId("ReadOnlyModelAccessor_18rw23_a2a");
      Style style = new StyleImpl();
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ")");
    editorCell.setCellId("Constant_18rw23_d0");
    Style style = new StyleImpl();
    new FunctionCallParensStyleClass(this).apply(style, editorCell);
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
    editorCell.getStyle().putAll(style);
