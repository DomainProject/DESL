...
/*package*/ class ParensExpression_EditorBuilder_a extends AbstractEditorBuilder {
    ...
    EditorCell editorCell = ((_FunctionTypes._return_P0_E0<EditorCell>) () -> {
      cell.setAction(CellActionType.DELETE, new CellActionWithReadAccess() {
        public void execute(EditorContext editorContext) {
          ...
          SNode inner = SLinkOperations.getTarget(node, LINKS.expression$HKAI);
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new expressionSingleRoleHandler_v011gl_b0(myNode, LINKS.expression$HKAI, getEditorContext());
