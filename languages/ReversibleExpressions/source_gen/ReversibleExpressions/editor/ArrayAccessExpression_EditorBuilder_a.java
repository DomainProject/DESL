...
/*package*/ class ArrayAccessExpression_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new expressionSingleRoleHandler_jeymkr_a0a0(myNode, LINKS.expression$HKAI, getEditorContext());
    return provider.createCell();
  }
  private static class expressionSingleRoleHandler_jeymkr_a0a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public expressionSingleRoleHandler_jeymkr_a0a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
