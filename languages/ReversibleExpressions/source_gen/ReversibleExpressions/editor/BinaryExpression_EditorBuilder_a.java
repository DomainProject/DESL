...
/*package*/ class BinaryExpression_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new leftSingleRoleHandler_uefsp_a1a(myNode, LINKS.left$KPKR, getEditorContext());
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new rightSingleRoleHandler_uefsp_a5a(myNode, LINKS.right$KPZS, getEditorContext());
    return provider.createCell();
  }
