...
/*package*/ class BinaryExpression_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_uefsp_a0a() {
    return (boolean) BinaryExpression__BehaviorDescriptor.requiresParensAroundArgument_id3_qrK00j4rM.invoke(myNode, SLinkOperations.getTarget(myNode, LINKS.left$KPKR));
  }
  private boolean nodeCondition_uefsp_a2a() {
    return (boolean) BinaryExpression__BehaviorDescriptor.requiresParensAroundArgument_id3_qrK00j4rM.invoke(myNode, SLinkOperations.getTarget(myNode, LINKS.left$KPKR));
  }
  private boolean nodeCondition_uefsp_a4a() {
    return (boolean) BinaryExpression__BehaviorDescriptor.requiresParensAroundArgument_id3_qrK00j4rM.invoke(myNode, SLinkOperations.getTarget(myNode, LINKS.right$KPZS));
  }
    ...
    EditorCell editorCell = ((_FunctionTypes._return_P0_E0<EditorCell>) () -> {
      cell.setAction(CellActionType.DELETE, new CellActionWithReadAccess() {
        public void execute(EditorContext editorContext) {
          ...
          SNode unwrapped = SNodeOperations.replaceWithAnother(node, SLinkOperations.getTarget(node, LINKS.left$KPKR));
        ...
        public boolean canExecute_inReadAction(EditorContext editorContext) {
          ...
          SNode replacement = SLinkOperations.getTarget(node, LINKS.left$KPKR);
    ...
    EditorCell editorCell = ((_FunctionTypes._return_P0_E0<EditorCell>) () -> {
      cell.setAction(CellActionType.DELETE, new CellActionWithReadAccess() {
        public void execute(EditorContext editorContext) {
          {
            ...
            SNode child = SLinkOperations.getTarget(node, LINKS.left$KPKR);
            ...
            if (!(GrammarCellsUtil.isExactly(childConcept, CONCEPTS.ReversibleExpression$Zd))) {
              SNodeFactoryOperations.setNewChild(node, LINKS.left$KPKR, null);
              return;
            }
          }

          SNode unwrapped = SNodeOperations.replaceWithAnother(node, SLinkOperations.getTarget(node, LINKS.right$KPZS));
          boolean caretLeft = true;
          if (caretLeft) {
            SelectionUtil.selectLabelCellAnSetCaret(editorContext, unwrapped, SelectionManager.FIRST_CELL, 0);
          } else {
        ...
        public boolean canExecute_inReadAction(EditorContext editorContext) {
          ...
          SNode replacement = SLinkOperations.getTarget(node, LINKS.right$KPZS);
          SContainmentLink containmentLink = node.getContainmentLink();
          if (containmentLink == null) {
            return true;
          }
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new leftSingleRoleHandler_uefsp_a0a1a(myNode, LINKS.left$KPKR, getEditorContext());
  ...
  private static class leftSingleRoleHandler_uefsp_a0a1a extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.left$KPKR, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.left$KPKR, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.left$KPKR);
      }
    ...
    protected EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.left$KPKR));
      try {
    ...
    private boolean nodeCondition_uefsp_a0a0b0() {
      return SLinkOperations.getTarget(myNode, LINKS.left$KPKR) == null;
    }
  }
    ...
    EditorCell editorCell = ((_FunctionTypes._return_P0_E0<EditorCell>) () -> {
      ...
      cell.setSubstituteInfo(new ConstantSubstituteInfo(getEditorContext(), myNode) {
        public List<IToken> getSyntaxElementsBefore(SNode node) {
          ...
          ListSequence.fromList(result).addElement(new ChildToken(SLinkOperations.getTarget(node, LINKS.left$KPKR)));
          ListSequence.fromList(result).addElement(new ConstantToken(")"));
          return result;
        }
        public List<IToken> getSyntaxElementsAfter(SNode node) {
          List<IToken> result = ListSequence.fromList(new ArrayList<IToken>());
          ListSequence.fromList(result).addElement(new ConstantToken("("));
          ListSequence.fromList(result).addElement(new ChildToken(SLinkOperations.getTarget(node, LINKS.right$KPZS)));
          ListSequence.fromList(result).addElement(new ConstantToken(")"));
          return result;
        }
      });
    ...
    EditorCell editorCell = ((_FunctionTypes._return_P0_E0<EditorCell>) () -> {
      cell.setAction(CellActionType.DELETE, new CellActionWithReadAccess() {
        public void execute(EditorContext editorContext) {
          {
            // replace with placeholder
            SNode child = SLinkOperations.getTarget(node, LINKS.right$KPZS);
            SAbstractConcept childConcept = SNodeOperations.getConcept(child);
            if (!(GrammarCellsUtil.isExactly(childConcept, CONCEPTS.ReversibleExpression$Zd))) {
              SNodeFactoryOperations.setNewChild(node, LINKS.right$KPZS, null);
              return;
            }
          }
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new rightSingleRoleHandler_uefsp_a0a5a(myNode, LINKS.right$KPZS, getEditorContext());
    return provider.createCell();
  }
  private static class rightSingleRoleHandler_uefsp_a0a5a extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      EditorCell editorCell = getUpdateSession().updateChildNodeCell(child);
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.right$KPZS, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.right$KPZS, child));
      installCellInfo(child, editorCell, false);
      return editorCell;
    }
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.right$KPZS);
      }
      Style style = new StyleImpl();
    ...
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.right$KPZS));
      try {
        EditorCell editorCell = super.createEmptyCell();
    ...
    private boolean nodeCondition_uefsp_a0a0f0() {
      return SLinkOperations.getTarget(myNode, LINKS.right$KPZS) == null && SLinkOperations.getTarget(myNode, LINKS.left$KPKR) != null;
    }
  }
