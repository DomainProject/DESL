...
/*package*/ class ReversibleFunctionCall_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ReversibleFunctionCall_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_5jceo0_a");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.function$EyYZ;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.function$EyYZ);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.function$EyYZ);
    }
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new ReferenceCellContext(getNode(), getNode(), referenceLink), new SubstituteInfoPartExt[]{new ReversibleFunctionCall_function_cellMenu_5jceo0_a0a0(), new SChildSubstituteInfoPartEx(editorCell)}));
  ...
  public static class ReversibleFunctionCall_function_cellMenu_5jceo0_a0a0 extends PrimaryReferentMenuCellMenuPart {
    public ReversibleFunctionCall_function_cellMenu_5jceo0_a0a0() {
    }
    @NotNull
    @Override
    protected IReferentPresentationProvider getMatchingTextProvider() {
      return PresentationProviders.PRESENTATION_5jceo0_a0a0a;
    }
    @NotNull
    @Override
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_5jceo0_b0");
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new actualsListHandler_5jceo0_c0(myNode, getEditorContext());
  ...
  private static class actualsListHandler_5jceo0_c0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public actualsListHandler_5jceo0_c0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(actualsListHandler_5jceo0_c0.this.getNode(), LINKS.actuals$EywX));
      try {
    ...
    private EditorCell createReadOnlyModelAccessor_0() {
      ...
      editorCell.setCellId("ReadOnlyModelAccessor_5jceo0_a2a");
      Style style = new StyleImpl();
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ")");
    editorCell.setCellId("Constant_5jceo0_d0");
    Style style = new StyleImpl();
    new FunctionCallParensStyleClass(this).apply(style, editorCell);
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
    editorCell.getStyle().putAll(style);
