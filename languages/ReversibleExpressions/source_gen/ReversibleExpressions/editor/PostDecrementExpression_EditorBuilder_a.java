...
/*package*/ class PostDecrementExpression_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new expressionSingleRoleHandler_ppmrbk_a0a0(myNode, LINKS.expression$HKAI, getEditorContext());
    return provider.createCell();
  }
  private static class expressionSingleRoleHandler_ppmrbk_a0a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public expressionSingleRoleHandler_ppmrbk_a0a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
    ...
    EditorCell editorCell = ((_FunctionTypes._return_P0_E0<EditorCell>) () -> {
      ...
      cell.setSubstituteInfo(new ConstantSubstituteInfo(getEditorContext(), myNode) {
        public List<IToken> getSyntaxElementsBefore(SNode node) {
          ...
          ListSequence.fromList(result).addElement(new ChildToken(SLinkOperations.getTarget(node, LINKS.expression$HKAI)));
          return result;
        }
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_ppmrbk_a0b0");
