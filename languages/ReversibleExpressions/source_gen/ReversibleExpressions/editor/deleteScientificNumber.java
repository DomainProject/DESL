...
public class deleteScientificNumber {
  ...
  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        SNodeOperations.replaceWithAnother(node, createNumberLiteral_jmns5q_a0a0a0a(SPropertyOperations.getString(node, PROPS.prefix$Su1m)));
      }
  ...
  private static SNode createNumberLiteral_jmns5q_a0a0a0a(String p0) {
    SNodeBuilder n0 = new SNodeBuilder().init(CONCEPTS.NumberLiteral$74);
    n0.setProperty(PROPS.value$jw9Y, p0);
    return n0.getResult();
  }
