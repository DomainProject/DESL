...
/*package*/ class NumberLiteral_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createSplittableCell_0() {
    ...
    try {
      ...
      SProperty property = PROPS.value$jw9Y;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));

      CellProviderWithRole provider = new SplittablePropertyCellProvider(myNode, PROPS.value$jw9Y, getEditorContext(), new NumberLiteralTokenizer());
