...
/*package*/ class ReversibleFunction_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  public ReversibleFunction_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_a8zlsv_a");
  ...
  private EditorCell createComponent_0() {
    EditorCell editorCell = getCellFactory().createEditorComponentCell(myNode, "ReversibleFunctions.editor.revFunctionSignature");
    return editorCell;
  }
