...
public final class ReversibleMacro__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Object> evaluateStatically_id6ydhAa2hHmU = new SMethodBuilder<Object>(new SJavaCompoundTypeImpl(Object.class)).name("evaluateStatically").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7533755140567127482L).languageId(0xa63b80c6b9db7397L, 0x5eb14d5ab5f74626L).build2(SMethodBuilder.createJavaParameter((Class<List<SNode>>) ((Class) Object.class), ""));
  ...
  /*package*/ static boolean isStaticallyEvaluatable_id6ydhAa2hH2s(@NotNull SNode __thisNode__) {
    SNode content = SNodeOperations.copyNode(SLinkOperations.getTarget(__thisNode__, LINKS.content$L7Vn));
  ...
  /*package*/ static boolean resultIsLValue_id4b64BCc3TpW(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getBoolean(__thisNode__, PROPS.resultIsLValue$6M7F) || (boolean) Expression__BehaviorDescriptor.isLValue_id6iIoqg1yDKH.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.content$L7Vn));
  }
