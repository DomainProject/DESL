...
public final class ReversibleScript__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x5eb14d5ab5f74626L, 0xa63b80c6b9db7397L, 0x56ee1731fef0eae5L, "ReversibleFunctions.structure.ReversibleScript");
  ...
  /*package*/ static Iterable<SNode> allReferenceableContentsInChunk_id6clJcrKmVSn(@NotNull SNode __thisNode__) {
    List<SNode> retList = new ArrayList<SNode>();
    ListSequence.fromList(retList).addSequence(ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.structs$ZHxn)));
    ListSequence.fromList(retList).addSequence(ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.reversibleItems$5wYj)));
    return retList;
  }

  /*package*/ ReversibleScript__BehaviorDescriptor() {
  }
